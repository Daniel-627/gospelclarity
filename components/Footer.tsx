...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 py-10">
      {/* Top Part */}
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 border-b border-gray-300 dark:border-gray-700 pb-10">
        ...
        <div>
          ...
          <form className="flex items-center space-x-2">
            <input
              ...
              className="p-2 w-full rounded border border-gray-300 dark:border-gray-700 bg-transparent focus:outline-none"
            />
